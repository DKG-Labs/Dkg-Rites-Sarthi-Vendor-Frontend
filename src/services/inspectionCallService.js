...
const inspectionCallService = {
    ...
    try {
      ...
      const transformedData = {
        inspectionCall: {
          ...
          createdBy: user.userId// Default numeric user ID (backend expects Integer, not String)
        },
        rmInspectionDetails: {
  ...
  createFinalInspectionCall: async (finalInspectionData) => {
    try {
      console.log('📤 Sending Final IC data to backend:', JSON.stringify(finalInspectionData, null, 2));
