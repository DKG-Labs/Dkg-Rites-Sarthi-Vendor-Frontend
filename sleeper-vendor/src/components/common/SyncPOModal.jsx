...
const SyncPOModal = ({ isOpen, onClose, onSuccess, vendorCode: propVendorCode, plantId }) => {
    ...
    const handleSync = async (e) => {
        ...
        try {
            ...
            if (!immsToken && apiService.authenticateIMMS) {
            ...
            if (syncType === 'POMA DATA') {
                ...
                if (formData.poNo) {
                    try {
                        const poDateRes = await apiService.getPoDateByPoNo(formData.poNo.trim());
    ...
    const handleSave = async () => {
        if (syncType === 'IBS_CASE_NO') {
            ...
            try {
                ...
                const res = await apiService.saveIbsCaseNo(savePayload);
                setStatus('success');
                if (onSuccess) {
